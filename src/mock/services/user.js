...
const nav = (options) => {
  ...
  const admin_nav = [
    ...
    },
    {
      parentId: 12,
      id: 121,
      path: '/marketing/addCustomer',
      name: 'addCustomer',
      component: 'BlankLayout',
      redirect: '/marketing/addCustomer/liveQRcode',
      meta: { title: '加客户', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 121,
      id: 1211,
      path: '/marketing/addCustomer/liveQRcode',
      name: 'liveQRcode',
    ...
    },
    {
      parentId: 121,
      id: 1212,
      path: '/marketing/addCustomer/welcomewords',
      name: 'welcomewords',
      component: 'marketing/welcomwrods',
